...
/*        for(int i=0;i<10;i++){
         ...
         male.setPassword("123456789");
         male.setGender("female");
         userDataService.addUser(male);

         userDataService.findById("male");

         male.setGender("male");
         userDataService.updateUser(male);

         
         System.out.println("male is "+userDataService.findById("male").getGender());
